package com.SprSt.StudySpring.Chapter4.ToDoClient;



import com.SprSt.StudySpring.Chapter4.ToDoClient.domain.ToDo;
import com.SprSt.StudySpring.Chapter4.ToDoClient.error.ToDoErrorHandler;
...
public class ToDoRestClient {
    ...
    public ToDo findById(String id) {
        ...
        params.put("id", id);
        return restTemplate.getForObject(properties.getUrl() + properties.getBasePath() +
                "/{id}", ToDo.class, params);
    }
